 ...
 * This is set to * to support all gitpod subdomains (a new subdomain for each container generated).
 * On a production site, this should be changed to the public domain name.
 */
$cookie_domain = '*';
